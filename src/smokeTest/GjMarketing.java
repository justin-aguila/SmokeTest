...
public class GjMarketing {
	...
	final String PASSWORD_LOGIN = "gotjunkaccesspw4"; //password resets from time to time, please contact any of the Delivery Team for the password if it resets. DO NOT change the password in salesforce
	final String TEST_USER_FIRSTNAME = "Marketing"; //add custom first name
	final String TEST_USER_LASTNAME = "AutoTest"; //add custom last name
	final String TEST_USER_EMAILADDRESS = "test@test.com";  //add customer email here
	...
	final String PROMO_CODE = "Justin$PromoGJ"; //add desired promo code here
	...
	final By NAV_TO_ESTIMATE = By.xpath("//a[contains(text(),'1-800-GOT-JUNK? - Marketing AutoTest')]");
	...
	final By NAV_TO_OPPORTUNITY = By.xpath("//a[contains(text(),'1-800-GOT-JUNK? - Marketing AutoTest')]");
	...
	public void EstimateWorkflow() {
		...
		//iAccept workflow. Remove the comment tag if this workflow is needed
