...
public class W1dSCUS {
	...
	final By EXTERIOR_BUTTON = By.xpath("//label[@for='j_id0:opp-detail:exterior']//span[@class='onoffswitch-switch']");
	final By TIME_SLOT = By.xpath("//*[@id=\"j_id0:j_id385:time-list\"]/div[2]/div[2]");
	final By SAVE_CONFIRM = By.id("save-opp-confirm");
	final By CALL_DISPOSITION = By.id("j_id0:j_id633:BookingOppDetailCallDisposition:call-disposition-form:call-disposition-w1d");
	...
	public void bos2Workflow() throws InterruptedException {
		...
		WebElement exteriorButton = wait.until(
				ExpectedConditions.elementToBeClickable(EXTERIOR_BUTTON));
		...
		Select callReason = new Select(driver.findElement(CALL_DISPOSITION));
				callReason.selectByVisibleText("Renovating");
