...
public class GjMarketingEstimatePresented {
	...
	final String TEST_USER_FIRSTNAME = "Marketing Estimate";
	final String TEST_USER_LASTNAME = "AutoTest";
	final String TEST_USER_EMAILADDRESS = "test@test.com";
	...
	final By NAV_TO_ESTIMATE = By.xpath("//a[contains(text(),'1-800-GOT-JUNK? - Marketing Estimate AutoTest')]");
	...
	final By NAV_TO_OPPORTUNITY = By.xpath("//a[contains(text(),'1-800-GOT-JUNK? - Marketing Estimate AutoTest')]");
