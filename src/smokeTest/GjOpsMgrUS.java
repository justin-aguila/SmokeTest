...
public class GjOpsMgrUS {
	...
	final String USER_LOGIN ="gjusa.opsmgr.tester@1800gotjunk.com.prod";
	final String PASSWORD_LOGIN = "gotjunkaccesspw2";
	final String TEST_USER_FIRSTNAME = "QA Justin";
	final String TEST_USER_LASTNAME = "AutoTest US";
	...
	final String TEST_USER_ZIP = "000111";
