...
public class SshFPUS {
	...
	final String USER_LOGIN ="sshusa.fp.tester@shackshine.com.prod";
	final String PASSWORD_LOGIN = "sshaccesspw5";
	...
	final By QUANTITY_FIELD = By.id("Quantity01u1500000Pak6R");
