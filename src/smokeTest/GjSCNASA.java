...
public class GjSCNASA {
	...
	final String TEST_USER_BUSINESS = "QA Justin NASA Test";
	...
	final String TEST_USER_PARENT = "Justin QA Test NASA Parent";
	...
	final By ACCOUNT_PARENT = By.id("search-parent-account");
	final By NASA_PARENT = By.id("ext-comp-1004");
    ...
    final By PARENT_EXPAND = By.id("parentAccountContainer");
	...
	public void bos2Workflow() throws InterruptedException {
		...
		Select comAccount = new Select(driver.findElement(By.id("j_id0:opp-detail:commercial-account-type")));
				comAccount.selectByVisibleText("National Accounts");
		...
		WebElement parentExpand = wait.until(
				ExpectedConditions.elementToBeClickable(PARENT_EXPAND));
				parentExpand.click();
				
		WebElement parentInput = wait.until(
				ExpectedConditions.elementToBeClickable(ACCOUNT_PARENT));
				parentInput.sendKeys(TEST_USER_PARENT);
