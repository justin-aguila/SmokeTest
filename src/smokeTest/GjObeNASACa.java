...
public class GjObeNASACa {
	...
	final String TEST_BUSINESS_NAME = "QA Justin NASA Test";
	final String TEST_USER_FIRSTNAME = "QA Justin";
	final String TEST_USER_LASTNAME = "OBE Price Book NASA Test";
	...
	final String TEST_ZIP = "W1N1W1";
	final String PROGRAM_CODE = "SMOKE-NASA-CA-PB";
	...
	public void stepThree() throws InterruptedException {
		...
		WebElement businessCheck = wait.until(
				ExpectedConditions.elementToBeClickable(BUSINESS_CHECKBOX));
				businessCheck.click();
		
		WebElement BusinessNameBox = wait.until(
				ExpectedConditions.elementToBeClickable(BUSINESS_NAME));
				BusinessNameBox.sendKeys(TEST_BUSINESS_NAME);
		...
		WebElement promoInput = wait.until(
				...
				promoInput.sendKeys(PROGRAM_CODE);
