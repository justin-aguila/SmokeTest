...
public class W1dFPCA {

	ChromeDriver driver;
	WebDriverWait wait;
	
	final String SITE_URL = "https://o2ebrands.force.com/wow1day/login";
	final String HOME_TITLE = "Login | WOW 1 DAY PAINTING";
	final String USER_LOGIN ="w1dcanada.fp.tester@wow1day.com.prod";
	final String PASSWORD_LOGIN = "wow1dayaccesspw2";
	...
	final String TEST_USER_ZIP = "00001";
	final String LINE_ITEM_QUANTITY = "10";
	final String PROMO_CODE = "Justin$PromoW1D";
	final String PAYMENT_AMOUNT ="480";
	final String PAINT_AMOUNT ="100";
	final String LABOR_AMOUNT ="100";
	...
	final By NAVIGATE_TO_OPPORTUNITY = By.xpath("//a[contains(text(),'WOW 1 DAY PAINTING')]");
	...
	final By NAV_TO_ESTIMATE = By.xpath("//a[contains(text(),'WOW 1 DAY PAINTING - QA Justin AutoTest')]");
	final By ADD_LINE_ITEM = By.xpath("//input[@title='Add Line Item']");
	final By FIRST_LINE_ITEM = By.id("01u1500000Pajrz");
	final By ESTIMATE_SELECT = By.xpath("//input[@title='Select']");
	final By QUANTITY_FIELD = By.id("Quantity01u1500000Pajrz");
	...
	final By PROPOSAL_SDOC = By.xpath("//input[@name='j_id0:j_id5:j_id49:j_id51:j_id52:j_id57:17:j_id59']");
	...
	final By NAV_TO_OPPORTUNITY = By.xpath("//a[contains(text(),'WOW 1 DAY PAINTING - QA Justin AutoTest')]");
	final By NEW_COGS = By.xpath("//input[@title='New Cost of Goods Sold']");
	...
	public void createAccount() throws InterruptedException {
		WebElement accountLink = wait.until(
				...
				ExpectedConditions.titleIs("Accounts: Home ~ WOW 1 DAY PAINTING"));
	...
	public void COGSWorkflow() throws InterruptedException {
			
		WebElement NewCOGS = wait.until(
						ExpectedConditions.elementToBeClickable(NEW_COGS));
						NewCOGS.click();
						
		WebElement inputAmountCOGS1 = wait.until(
						ExpectedConditions.elementToBeClickable(COGS_AMOUNT_FIELD));
						inputAmountCOGS1.sendKeys(PAINT_AMOUNT);
						
		Select CogsType1 = new Select(driver.findElement(By.id("00N1500000H6agP")));
						CogsType1.selectByVisibleText("Paint/Supplies");
			
		WebElement SaveAndNewCogs = wait.until(
						ExpectedConditions.elementToBeClickable(SAVE_NEW_COGS));
						SaveAndNewCogs.click();
						
		WebElement inputAmountCOGS2 = wait.until(
						ExpectedConditions.elementToBeClickable(COGS_AMOUNT_FIELD));
						inputAmountCOGS2.sendKeys(LABOR_AMOUNT);
						
		Select CogsType2 = new Select(driver.findElement(By.id("00N1500000H6agP")));
						CogsType2.selectByVisibleText("Labor");
						
		WebElement SavePayment = wait.until(
						ExpectedConditions.elementToBeClickable(COGS_SAVE));
						SavePayment.click();
